						...
						<script>
							$(document).ready(function(){
								$('#item<?=$item_num?>').mouseover(function(){
									...
									$('#item<?=$item_num?>').append("<h2 style='background-color:#fa2828;color:#ffffff;opacity:0.4;'><?=$row[subject]?></h2><h4 style='float:right;margin-right:5px;margin-top:200px'><?=$item_date ?></h4>");
								});
