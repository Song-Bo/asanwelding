	...
	<div class="wrap">
		<div class="content" id="content">
			...
			?>
				...
				<!-- start of #write_form -->
				<div id="write_form">
<div class="write_line"></div><!-- 밑줄 -->
				<div class="write_row1">
					<div class="col1">작성자</div>
					<div class="col2"><input type="text" name="writer" value="관리자"></div>
...
<div class="clear"></div>
				...
				<div id="write_button">
					<a href="#"><img src="../../img/board/ok.png" onclick="check_input()"></a>&nbsp;
